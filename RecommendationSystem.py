...
from GUIHelper import hybrid, personalized_movies_recommendations_v1, personalized_movies_recommendations_v2, movie_dict
...
recommendation_type = st.selectbox('Chọn loại gợi ý:', ['Hybrid', 'Cá nhân hoá V1','Cá nhân hoá V2'])
...
#     user_ratings = {input['movie']: input['rating'] for input in st.session_state['rating_inputs']}
#     if st.button('Đề xuất'):
#         recommendations_user_input = user_input_ratings_recommendations(user_ratings)
#         display_recommendations(user_input_ratings_recommendations, f"Phim đề xuất cho bạn")
